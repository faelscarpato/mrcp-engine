...
export class MrcpDashboardPanel {
  ...
  public static createOrShow(extensionUri: vscode.Uri, result?: MrcpSuiteResult): MrcpDashboardPanel {
  ...
  private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, result?: MrcpSuiteResult) {
    this._panel = panel;
