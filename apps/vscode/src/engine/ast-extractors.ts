...
import {
  calculateFunctionBodyComplexity,
  parseTypedParameters
} from './ast-helpers';
import { extractEnterpriseSymbols } from './ast-enterprise';
...
export function extractTypedAstSymbols(
  ...
  symbols.push(...extractEnterpriseSymbols(content, ext));
  return symbols;
}
