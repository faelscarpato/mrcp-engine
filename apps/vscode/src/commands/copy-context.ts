...
import { packWorkspaceContextForAi, packSingleFileContext } from '../engine/context-packer';
...
export async function copyFileContextCommand(ctx: CommandContext): Promise<void> {
