export const MCP_TOOLS = [
  {
    ...
    inputSchema: {
      type: "object",
      properties: { repo: { type: "string", description: "Full URL of the GitHub repository (e.g., https://github.com/user/project)" } },
      required: ["repo"]
    }
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { repo: { type: "string", description: "Full URL of the GitHub repository" } },
      required: ["repo"]
    }
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        repo: { type: "string", description: "Full URL of the GitHub repository or local directory" },
        taskContext: { type: "string", description: "Optional context or task description" }
      },
      required: ["repo"]
    }
  },
