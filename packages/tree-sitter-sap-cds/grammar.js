module.exports = grammar({
  ...
  rules: {
    ...
    annotation_property: ($) =>
      seq(field("key", $.identifier), ":", field("value", $._annotation_value)),
    ...
    parameter_clause: ($) =>
      seq(caseInsensitive("with parameters"), sepBy1(",", $.parameter)),
    ...
    select_list: ($) =>
      seq("{", sepBy(",", $.select_element), optional(","), "}"),
    ...
    qualified_field: ($) =>
      seq(field("source", $.identifier), ".", field("field", $.identifier)),
    ...
    function_call: ($) =>
      seq(field("function", $.identifier), "(", sepBy(",", $._expression), ")"),
