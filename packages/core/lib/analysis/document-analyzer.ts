...
import type { 
  DocumentFormat, DocumentCategory, ParsedDocument, 
  DocumentKnowledgeGraph, DocumentRepositoryAnalysis, 
  AnalyzeDocumentRepoOptions 
} from "./document-types.js";
import { parseMarkdown } from "./parsers/markdown.js";
import { parseTabular } from "./parsers/tabular.js";
import { parsePlainText } from "./parsers/plaintext.js";
import { parseStructuredData } from "./parsers/structured.js";
import { parseDocx } from "./parsers/docx.js";
import { parseXlsx } from "./parsers/xlsx.js";
import { parsePdfText } from "./parsers/pdf.js";

export { parseMarkdown, parseTabular, parsePlainText, parseStructuredData, parseDocx, parseXlsx, parsePdfText };

// Re-export types for backward compatibility if needed by the consumer
...
export async function analyzeDocumentRepository(
  ...
  return {
    ...
    engineVersion: "2.5.0", // Atualizando a engineVersion reportada!
